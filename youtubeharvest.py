...
def Api_connect():
    Api_Id="AIzaSyBhDdrueMA55hZkq4kPoVM-DamkiT7BlZo"
        ...
        for video_id in video_ids:
            ...
            for item in response['items']:
                data=dict(Comment_Id=item['snippet']['topLevelComment']['id'],
                        Video_Id=item['snippet']['topLevelComment']['snippet']['textDisplay'],
...
client=pymongo.MongoClient("mongodb+srv://Sravan:sravan98@cluster0.5drocoj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",ssl=True)
...
def channels_table(channel_name_s): 
    ...
    for index,row in df_single_channel_detail.iterrows():
        ...
        try:
            ...
            news=f"Your Provided Channel_Name {channel_name_s}is Aleady Exists"
            return news
...
def comments_table(channel_name_s):
    ...
    create_query='''create table if not exists comments(Comment_Id varchar(1600) primary key,
                                                            Video_Id varchar(9880),
                                                            Comment_Text text,
                                                            Comment_Author varchar(1000),
...
if question=="1. All the videos and the channel name":
    ...
    query3='''select views as views,channel_name as channel_name,title as videotitle from videos  
    ...
    query4='''select comments as no_comments,title as videdotitle from videos where comments is not null'''
